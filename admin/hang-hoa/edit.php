    ...
    <div class="row col-11 mt-5 m-auto">
        ...
        <div class="card mx-auto">
            ...
            <div class="card-body">
                ...
                <form action="index.php?btn_update" method="POST" enctype="multipart/form-data" id="update_hang_hoa" onclick="return validateForm()">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" name="ten_hh" id="ten_hh" class="form-control" value="<?= $ten_hh ?>">
                        </div>
                        <div class="form-group col-sm-4">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="number" name="don_gia" id="don_gia" class="form-control" value="<?= $don_gia ?>">
                            <p id="don_gia_error" style="color: red;"></p>
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="giam_gia" class="form-label">Giảm giá (vnđ)</label>
                            <input type="number" name="giam_gia" id="giam_gia" class="form-control" value="<?= $giam_gia ?>" min="0">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="date" name="ngay_nhap" id="ngay_nhap" class="form-control" value="<?= $ngay_nhap ?>">
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="so_luot_xem" class="form-label">Số lượt xem</label>
                            <input type="text" name="so_luot_xem" id="so_luot_xem" readonly class="form-control" value="<?= $so_luot_xem ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label for="mo_ta" class="form-label">Mô tả sản phẩm</label>
                            <textarea id="txtarea" spellcheck="false" name="mo_ta" class="form-control form-control-lg mb-3 myTextarea " id="textareaExample" rows="3"><?= $mo_ta ?></textarea>
                        </div>
                    </div>
